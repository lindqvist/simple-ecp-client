...
public class RequestBuilder extends AbstractSAMLObjectBuilder<Request> {
	...
	public Request buildObject() {
		return buildObject(SAMLConstants.PAOS_NS,
				Request.DEFAULT_ELEMENT_LOCAL_NAME, SAMLConstants.PAOS_PREFIX);
	}

	/** {@inheritDoc} */
	@Override
	public Request buildObject(String namespaceURI, String localName,
