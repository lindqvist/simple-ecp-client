...
public interface Request extends SAMLObject, MustUnderstandBearing,
	...
	public static final QName DEFAULT_ELEMENT_NAME = new QName(
			SAMLConstants.PAOS_NS, DEFAULT_ELEMENT_LOCAL_NAME,
	...
	public static final QName TYPE_NAME = new QName(SAMLConstants.PAOS_NS,
			TYPE_LOCAL_NAME, SAMLConstants.PAOS_PREFIX);

	/** responseConsumerURL attribute name. */
	public static final String RESPONSE_CONSUMER_URL_ATTRIB_NAME = "responseConsumerURL";

	// service ska före response...url, hur ändra, var
	 ...
	 * 
	 * @param newResponseConsumerURL
	 *            the new responseConsumerURL attribute value
	 */
	 ...
	 * 
	 * @param newService
	 *            the new service attribute value
	 */
