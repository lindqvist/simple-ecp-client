...
/**
 * ExtractField contains methods which can extract fields from SOAP Envelope
 * headers.
 * 
...
public class ExtractField {
	 ...
	 * 
	 * Would be better if this would be called from an independent class, it
	 * would extract the preferred IdP from a list that was returned from this
	 * class.
	 * 
	 * @param header
	 * @return
